...
#will this change w marketing cloud?
...
## get all pardot newsletters since Jan 1, 2023 - will need to save these values as a table
...
allSparkNLs <- allNLs %>% 
  filter(grepl('Spark', name) | grepl('Upcoming Events', name) | grepl('PEM', name) |
           ...
           grepl('Spring Appeal', name) | grepl('Fall Appeal', name)) %>%
...
#sparkNLs <- bind_rows(
#  sparkNLs %>% mutate(id = as.character(id), totalClicks = as.numeric(totalClicks)),
#  allSparkSF %>% mutate(id = as.character(id), totalClicks = as.numeric(totalClicks))
#)
...
#marketCatalystNLs <- bind_rows(
#  marketCatalystNLs %>% mutate(id = as.character(id), totalClicks = as.numeric(totalClicks)),
#  allMCSF %>% mutate(id = as.character(id), totalClicks = as.numeric(totalClicks))
#)
...
# get batch url clicks for Marketing Cloud/Salesforce - new 

SF_urlClicksOLD <- function (df) {
...
sparkNLs <- sparkNLs %>%
  ...
  filter(name != "PEM 2024-11-25 Tech + Innovation - UTC +4") %>%
  filter(name != "PEM 2024-12-18 Tech + Innovation - UTC +7") %>%
  filter(name != "PEM 2024-12-18 Tech + Innovation - UTC -3") %>%
  filter(name != "PEM 2024-12-18 Tech + Innovation - UTC +2") %>%
  filter(name != "PEM 2024-12-18 Tech + Innovation - UTC -5") %>%
  filter(name != "PEM 2024-12-18 Tech + Innovation - UTC -7") %>%
  filter(name != "PEM 2024-12-18 Tech + Innovation - UTC -10") %>%
  filter(name != "PEM 2024-12-18 Tech + Innovation - UTC +4") %>%
  filter(name != "PEM 2025-01-21 Tech + Innovation - UTC -7") %>%
  filter(name != "PEM 2025-01-21 Tech + Innovation - UTC -10") %>%
  filter(name != "PEM 2025-01-21 Tech + Innovation - UTC +10") %>%
  filter(name != "PEM 2025-01-21 Tech + Innovation - UTC -7") %>%
  filter(name != "PEM 2025-02-18 Tech + Innovation - UTC -3") %>%
  filter(name != "PEM 2025-02-18 Tech + Innovation - UTC +10") %>%
  filter(name != "PEM 2025-02-18 Tech + Innovation - UTC +7") %>%
  filter(name != "PEM 2025-02-18 Tech + Innovation - UTC +4") %>%
  filter(name != "PEM 2025-04-30 Tech + Innovation - UTC +10") %>%
  filter(name != "PEM 2025-04-30 Tech + Innovation - UTC +7") %>%
  filter(name != "PEM 2025-05-19 Tech + Innovation - UTC +10") %>%
  filter(name != "PEM 2025-05-19 Tech + Innovation - UTC +7") %>%
  filter(!(str_detect(name, "2024") & str_detect(name, "Spring Appeal"))) %>% 
  filter(!(str_detect(name, "2023") & str_detect(name, "Spring Appeal"))) %>%
  filter(!(str_detect(name, "2023") & str_detect(name, "Fall Appeal")))
...
# adding Salesforce/Marketing Cloud in -- new  
...
#  write.csv(allSparkStats, 'allSparkStats.csv')
  ...
  allSFSparkStats <- getSFSparkStats() 
